      ...
      >
        <div className="max-w-7xl mx-auto container">
          <div className="flex items-center justify-center">
            {/* Content */}
            <div className="flex-1 w-full max-w-[1040px] text-center items-center justify-center space-y-5">
              <h1 className="md:text-5xl text-2xl font-medium leading-16">
                Get A Customized Solution By <br />
              ...
              <p className="text-base mt-4">
                ...
                lead from here. Our Amazon publishing services include the three
                crucial areas of the publishing process: Production, Marketing,
                and Distribution. As the best publishers, our experience lies in
                publishing many books by professional writers. And our
                publishing experts have upgraded many authors to published book
                authors universally. It’s time for you to get famous!
              </p>
